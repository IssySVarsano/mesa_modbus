...
/*  {TYPE,    DIR,     ADDR,   COUNT, pin_name} */
    {HAL_BIT, HAL_IN,  0x0000,  1,     "relay-A"},
    {HAL_BIT, HAL_IN,  0x0001,  1,     "relay-B"},
    {HAL_BIT, HAL_IN,  0x0002,  1,     "relay-C"},
    {HAL_BIT, HAL_IN,  0x0003,  1,     "relay-D"},
    {HAL_BIT, HAL_OUT, 0x0000,  8,     "sense"  },
};
